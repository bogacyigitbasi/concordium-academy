...
* [Getting Started](README.md)
  * [Introduction to Concordium](ccd-academy/getting-started/introduction-to-concordium/README.md)
    ...
    * [🪙 CIS-2 Token Types](ccd-academy/getting-started/introduction-to-concordium/cis-2-token-types/README.md)
      * [Fungible Tokens](ccd-academy/getting-started/introduction-to-concordium/cis-2-token-types/fungible-tokens.md)
  ...
  * [👩💻 Setup Development Environment](ccd-academy/getting-started/setup-development-environment/README.md)
    ...
    * [Configure Node](ccd-academy/getting-started/setup-development-environment/configure-node/README.md)
      * [Setup a testnet node on your system](ccd-academy/getting-started/setup-development-environment/configure-node/setup-a-testnet-node-on-your-system.md)
      * [Run a docker testnet node](ccd-academy/getting-started/setup-development-environment/configure-node/run-a-docker-testnet-node.md)
      * [Use Concordium Testnet Node Service](ccd-academy/getting-started/setup-development-environment/configure-node/use-concordium-testnet-node-service.md)
    * [Install Concordium Wallet](ccd-academy/getting-started/setup-development-environment/install-concordium-wallet.md)
    * [Install Code Editor](ccd-academy/getting-started/setup-development-environment/install-code-editor.md)
...
* [🔥 Advanced Level Tutorials](advanced-level/advanced-level-tutorials/README.md)
  * [NFT Minting with ID 2.0](advanced-level/advanced-level-tutorials/nft-minting-with-id-2.0/README.md)
    * [The Verifier Backend](advanced-level/advanced-level-tutorials/nft-minting-with-id-2.0/the-verifier-backend.md)
...
* [💪 Full Stack dApp with ID 2.0](assignment-3/full-stack-dapp-with-id-2.0.md)

***

* [🏅 Claim NFT Badge](claim-nft-badge.md)
